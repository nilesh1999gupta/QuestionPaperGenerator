...
public partial class forgetapasswordspx : System.Web.UI.Page
{
    ...
    protected void btnforgetpassword_Click(object sender, EventArgs e)
    {
        ...
        string query = "select Password from Register2020 where Username='" + txtusername.Text + "'";
        ...
        if (dt.Rows.Count.ToString() == "1")
        {
            ...
            {
                con.Open();
                query = "update Register2020 set Password='" + txtcpasswd.Text + "' where Username='" + txtusername.Text + "'";
